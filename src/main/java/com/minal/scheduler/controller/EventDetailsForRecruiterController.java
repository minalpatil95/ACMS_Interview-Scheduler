...
@WebServlet(name = "EventDetailsForRecruiterController")
public class EventDetailsForRecruiterController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if( employee == null){
            ...
            RequestDispatcher rd = request.getRequestDispatcher("jsp/eventDetailsForRecruiter.jsp");
            rd.forward(request, response);
        }
    }
}
