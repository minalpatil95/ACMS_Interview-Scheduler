...
<head>
    ...
    <script src="../js/eventDetailsForRecruiter.js"></script>
    <script src="../js/createEvent.js"></script>
            ...
            <div class="container">
                ...
                <div id="navbarCollapse" class="collapse navbar-collapse">
                    <ul class="nav nav-tabs">
                        <li   class="active"><a href="/homepageinterviewer">Home</a></li>
                ...
                <div class="a-box">
                    <div class="a-box-inner a-padding-extra-large">
                        ...
                        <div class="a-row a-spacing-base">
                            ...
                            <div><b>Interviewer's Details :</b><div id="response"></div></div>
                            <a href="/selectint?id=<%=event.getId()%>">Select Interviewers</a>
                        </div>
                    </div>
                </div>
            </div>
