...
<div class="container">
            ...
            <div class="container">
                ...
                <div id="navbarCollapse" class="collapse navbar-collapse">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="/interviewrequest">Interview Requests (<%=pendingEvents.size()%>)</a></li>
    ...
    <div class="container-fluid">
        <%--<h4><b>Upcoming Events</b></h4><%=events.size()%>--%>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="item-box-big">
                    ...
                    <div class="col-sm-2"><%=e.getEventName()%></div>
                    ...
                    <div class="col-sm-1"><a href="/eventdetailsforinterviewer?id=<%=e.getId()%>">Details</a></div>
                </div>
            </div>
            <%}%>
        </div>
